            ...
            <div className="">
                <div className="flex flex-col lg:flex-row ">
                    <div className="w-full lg:w-1/2 hidden lg:block bg-[#ffedd4]">
                        <div className="absolute top-30 lg:top-20 left-10 z-10 ">
                            <h2 className="text-black text-4xl GolosText font-semibold">Login</h2>
                    ...
                    <div className="w-full lg:w-1/2">
                        <div className="flex items-center justify-center px-[8%] lg:px-[16%] py-15 min-h-screen">
                            <div className="border w-[90%] max-w-xl p-10 border-black rounded-2xl ">
                                ...
                                <h2 className="text-3xl Lufga font-bold text-center mb-3">Login</h2>
                                <p className="text-gray-500 text-center mb-6">welcome please login to your account</p>
                                <div className="space-y-5">
                                    ...
                                    <div className="flex justify-between mb-8">
                                        ...
                                        <a className="text-(--second) cursor-pointer">Forgot Password</a>
                                    </div>
